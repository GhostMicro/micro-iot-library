...
import {
  ...
  ChevronRight, ExternalLink, Filter, Code, Info, Layout, ArrowLeft
} from 'lucide-react';
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 gap-8">
          <div>
            ...
            <div className="flex items-center gap-4 mt-8">
              <Link href="/projects" className="flex items-center gap-2 bg-orange-500/10 border border-orange-500/20 px-6 py-3 rounded-xl text-xs font-black uppercase text-orange-400 hover:bg-orange-500 hover:text-black transition-all group">
                <Layout size={16} />
                Explore Module Projects
